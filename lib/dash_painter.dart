...
class _DashPainter extends CustomPainter {
  ...
  Path _getPath(Size size) {
    ...
    switch (borderType) {
      ...
      case BorderType.RRect:
        path = _getRRectPath(size, radiusTopLeft: radiusTopLeft,
  ...
  Path _getRRectPath(Size size,
      {Radius radiusTopLeft, Radius radiusTopRight, Radius radiusBottomLeft, Radius radiusBottomRight}) {
    return Path()
      ..addRRect(
